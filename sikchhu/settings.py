"""
Django settings for sikchhu project.
...
SECRET_KEY = 'django-insecure-nlz8r-!r5(nu(+2nbsf-umw)q_ivaobdr#uyav9zs-d(=#6+2i'
...
WSGI_APPLICATION = 'sikchhu.wsgi.application'
